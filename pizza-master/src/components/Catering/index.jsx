      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 p-6 rounded-lg shadow-lg">
            <h3 className="text-2xl font-bold text-white mb-4">Events & Parties</h3>
          ...
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 p-6 rounded-lg shadow-lg">
            <h3 className="text-2xl font-bold text-white mb-4">Corporate Catering</h3>
            <p className="text-white/90 mb-4">
          ...
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 p-6 rounded-lg shadow-lg">
            <h3 className="text-2xl font-bold text-white mb-4">Weddings & Special Occasions</h3>
            <p className="text-white/90 mb-4">
