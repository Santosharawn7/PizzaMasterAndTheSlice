...
class PizzaMasterNLP:
    def __init__(self):
        ...
        self.response_templates = {
            ...
            'pricing': "Our pizza prices range from $18 to $30 depending on the type and ingredients. For example, Margherita is $18, Pepperoni is $22, and our Supreme pizza is $28. Would you like to see our full menu with all prices?",
