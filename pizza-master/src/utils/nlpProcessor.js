...
class PizzaMasterNLP {
  constructor() {
    ...
    this.responseTemplates = {
      ...
      chef: "Chef Ashish Silwal is our master pizza chef from Adelaide, South Australia. He brings authentic pizza-making expertise and passion to every pizza we create. You can learn more about him on our About page!",
      owner: "The owners of Pizza Master & The Slice are passionate about bringing authentic Italian pizza to Adelaide, South Australia. You can see them in our gallery! Meet the passionate owners behind Pizza Master & The Slice.",
      location: "We are based in Adelaide, South Australia (Duffield Avenue Munnopara, Adelaide SA 5115), and serve the entire Adelaide and surrounding areas with our mobile pizza services. We bring our pizza truck directly to your location!",
