  ...
  const pizzaPackages = [
    {
      ...
      price: "$29.99 AUD",
      perPerson: true,
      description: "The Classic includes unlimited pizzas and dessert. The package is available for a duration of 2 hours and requires a minimum of 30 guests.",
    ...
    },
    {
      ...
      price: "$34.99 AUD",
      perPerson: true,
      description: "The Supreme includes unlimited pizzas, unlimited soft drinks, and dessert. The package is available for a duration of 2 hours and requires a minimum of 30 guests.",
      deliveryInfo: "We also accept delivery and takeaway orders with a minimum of 25 pizzas. Each pizza is priced at $25.",
      minGuests: 30,
      duration: "2 hours",
      includes: ["Unlimited pizzas", "Unlimited soft drinks", "Dessert"],
      pizzas: [
        "Garlic Pizza", "Margherita", "The Meat feast", "Pepperoni with spicy honey", 
    ...
    },
    {
      ...
      price: "$39.99 AUD",
      perPerson: true,
      description: "The Deluxe includes unlimited pizzas, unlimited soft drinks, antipasto platter, and dessert. The package is available for a duration of 2 hours and requires a minimum of 40 guests.",
      deliveryInfo: "We also accept delivery and takeaway orders with a minimum of 25 pizzas. Each pizza is priced at $25.",
      minGuests: 40,
      duration: "2 hours",
      includes: ["Unlimited pizzas", "Unlimited soft drinks", "Antipasto platter", "Dessert"],
      pizzas: [
        "Garlic Pizza", "Margherita", "The Meat feast", "Pepperoni with spicy honey", 
