...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="min-h-screen light-wood-texture">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 space-y-8">
            ...
            <div>
              ...
              <p className="text-lg text-woodbrown-700 mb-4">
                Pizza Master & The Slice ("we," "our," or "us") values your
                privacy and is committed to protecting your personal
                information. This Privacy and Purchase Policy outlines how we
                collect, use, and protect your data, and establishes our terms
                for purchases, event bookings, and payments.
              </p>
              <p className="text-lg text-woodbrown-700">
                By accessing our website, placing an order, or booking an event,
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-lg text-woodbrown-700 space-y-2 ml-4">
                <li>
                  ...
                  phone number, and billing details when you place an order or
                  book an event.
                </li>
                <li>
                  <strong>Event Details:</strong> Date, location, and
                  preferences related to your catering or private event.
                </li>
                <li>
                  <strong>Payment Information:</strong> Processed securely via
                  trusted payment gateways. We do not store your full credit
                  card information.
                </li>
                <li>
                  <strong>Website Usage Data:</strong> Non-personal data such as
                  IP address, browser type, and analytics cookies to improve
                  site performance.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-lg text-woodbrown-700">
                All online transactions are processed through encrypted payment
                systems. However, no electronic transmission is 100% secure, and
            ...
            <div>
              ...
              <p className="text-lg text-woodbrown-700">
                ...
                purposes. You can disable cookies in your browser settings, but
            ...
            <div>
              <h2 className="text-2xl font-bold text-woodbrown-800 mb-4 font-serif italic">
                6. Purchase & Refund Policy
              </h2>
              <ul className="list-disc list-inside text-lg text-woodbrown-700 space-y-2 ml-4">
                <li>
                  <strong>Pre-orders:</strong> Highly recommended to guarantee
                  your preferred item or event date.
                </li>
                <li>
                  <strong>Advance Payment:</strong> A 50% advance payment is
                  required to confirm your booking. The remaining balance is due
                  on the day of the event, prior to the start of service.
                </li>
                <li>
                  <strong>Refunds & Cancellations:</strong>
                  <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                    <li>
                      All sales are final due to the preparation required for
                      private events.
                    </li>
                    <li>
                      Refunds are available only if cancellation is made at
                      least 7 days prior to the event.
                    </li>
                    <li>
                      Advance payments are non-refundable but may be applied to
                      a rescheduled event if agreed upon in advance.
                    </li>
                  </ul>
                </li>
                <li>
                  <strong>Order Modifications:</strong> Allowed up to 48 hours
                  before the event.
                </li>
                <li>
                  <strong>Payment Options:</strong> We accept cash, card, and
                  contactless payments.
                </li>
                <li>
                  <strong>No Show Policy:</strong> Failure to appear for a
                  confirmed event will result in forfeiture of payment.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-lg text-woodbrown-700">
                Pizza Master & The Slice is not responsible for personal items,
                property loss, or injuries occurring at events we cater or host.
                Customers are responsible for ensuring safe conditions at their
                venue.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-lg text-woodbrown-700">
                We may update this policy periodically to reflect operational,
                legal, or regulatory changes. The revised date will always be
      ...
      <Footer pageType="privacy" scrollToSection={scrollToSection} />
      <ChatWidget />
    </div>
  );
};
